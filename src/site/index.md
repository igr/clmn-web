`Clmn` is a beautiful task board native app for macOS. It is thoughtfully simple and unbearably efficient; nothing fancy, just enough. Tasks require dedication: that's the only way of getting things done.
